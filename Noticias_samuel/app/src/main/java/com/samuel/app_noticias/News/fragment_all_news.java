...
public class fragment_all_news extends android.support.v4.app.Fragment {
    ...
    void getRecyclerView_sources() {
        requestDataSources("https://newsapi.org/v2/sources?country=br&apiKey=4c451402f34f4c65b30da5a2db93eaaf");
    }
...
//        requestDataArticles("https://newsapi.org/v2/top-headlines?country=br&apiKey=4c451402f34f4c65b30da5a2db93eaaf");
        requestDataArticles("https://newsapi.org/v2/top-headlines?sources=" + name + "&apiKey=" + Constants.API_KEY);
    }
